...
public final class ActivitySetupBinding implements ViewBinding {
  ...
  private ActivitySetupBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton btnClearData,
      @NonNull MaterialButton btnSave, @NonNull TextInputEditText editUrl) {
  ...
  public static ActivitySetupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySetupBinding((LinearLayout) rootView, btnClearData, btnSave, editUrl);
    }
